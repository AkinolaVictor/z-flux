                        ...
                        <div className='w-full h-auto p-4 darkbg rounded-[10px] mt-7'>
                            ...
                            </div>
                            {
                                ...
                                <div className='w-full my-4 flex gap-3 justify-start items-center flex-wrap'>
                                    {
                                        comp_data.similar.map((item, index)=>{
                                            return (
                                        ...
                                        listOptions = {
                                            {
                                                ...
                                                setter: (value)=>{setLanguage(value)}
                                            }
                                        }
                                    />
                                    <CustomDropdown 
